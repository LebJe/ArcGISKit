...
public struct User: Codable, Equatable {
	...
	public func createFolder(name: String, gis: GIS) async throws -> String? {
	...
	public func addFile(name: String, data: Data, folder: String? = nil, type: String = "", tags: [String] = [], gis: GIS) async throws -> String {
